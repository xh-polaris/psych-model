...
SERVICE_NAME := psych.model
MODULE_NAME := github.com/xh-polaris/psych-model
...
new:
	hz.exe new $(IDL_OPTIONS) $(OUTPUT_OPTIONS) --service $(SERVICE_NAME) --mod $(MODULE_NAME) $(EXTRA_OPTIONS)
clean:
	rm -r ./output
